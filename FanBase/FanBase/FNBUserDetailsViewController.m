...
- (IBAction)pressOnce:(id)sender {
    ...
    NSArray *indie = @[@"Two Door Cinema Club", @"Arcade Fire", @"Bastille", @"Walk The Moon", @"Death Cab for Cutie", @"The National", @"The xx", @"R.E.M.", @"The Killers", @"The Black Keys", @"Passion Pit", @"Radiohead", @"The White Stripes", @"Florence + The Machine", @"Vampire Weekend", @"alt-J", @"The Shins", @"The Strokes", @"Modest Mouse", @"The Cure", @"Pixies", @"Imagine Dragons", @"Phoenix", @"Weezer", @"The Smiths", @"Bon Iver", @"The 1975", @"Beck", @"Arctic Monkeys", @"Foster the People"];
    NSArray *rNb = @[ @"Justin Timberlake", @"sher ", @"ugust Alsina", @"hitney Houston", @"estiny Child", @"ason Derulo", @"ohn Legend ", @"nita Baker ", @"LC", @"obin Thicke", @"WV", @"Chris Brown", @"iara ", @"anet Jackson", @"obby Brown", @"odeci", @"oyz II Men", @"meli Sande ", @"rey Songz ", @"abyface ", @"anelle Monae", @"axwell ", @". Kelley ", @"oni Braxton", @"randy", @"ary J. Blige", @"licia Keys ", @"lackstreet ", @"eyonce ", @"e-Yo", @"ichael Jackson" ];
    ...
    NSArray *arrayOfGenres = @[comedy, metal, kPop, reggae, punk, funk, blues];
    for (NSArray *artistsArray in arrayOfGenres) {
        [FNBFirebaseClient fillDatabaseWithArrayOfArtists:artistsArray];
    }
//    [FNBFirebaseClient fillDatabaseWithArrayOfArtists:pop];
}
